...
- [Mount Ballor](mount-ballor.md) — which turns and flings its wind.
- [Diamond River](diamond-river.md) — whose course the wind follows.
- [Panklin Citadel](panklin-citadel.md) — the walled city to its south.
